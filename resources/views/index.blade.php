...
<head>
    ...
    <link rel="icon" href="{{asset('themes/images/favicon/1.png')}}" type="image/x-icon">
    <link rel="shortcut icon" href="{{asset('themes/images/favicon/1.png')}}" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('theme/css/front.css')}}">
</head>
